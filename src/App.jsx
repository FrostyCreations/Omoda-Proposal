...
function App({ hideEditButton }) {
  ...
  const navLinks = proposalData.sections
  ...
  return (
    <div className="app-container">
        ...
        <div className="nav-container">
          <a href="#home" className="logo" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            {proposalData.client.logoUrl ? (
              <BrandLockup client={proposalData.client} />
            ) : (
              <>
                <div style={{
                  ...
                  {proposalData.client.logoText}
                </div>
                <span style={{color: 'var(--text-primary)', fontWeight: 800, fontSize: '1.2rem', marginLeft: '4px'}}>{proposalData.client.logoSubtext}</span>
              </>
            )}
          </a>
      ...
      <main>
        <DealerHero data={proposalData.hero} />
      ...
      {!hideEditButton && (
        <Link
          ...
          style={{
            ...
            fontSize: '0.9rem',
            textDecoration: 'none',
            boxShadow: '0 4px 20px rgba(48, 54, 58, 0.4)',
            transition: 'transform 0.2s, box-shadow 0.2s',
          }}
          onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 8px 30px rgba(48, 54, 58, 0.5)'; }}
          onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 4px 20px rgba(48, 54, 58, 0.4)'; }}
        >
