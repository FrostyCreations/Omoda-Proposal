        ...
        >
          ...
          >
             <div className="glass-panel text-center visual-panel" style={{ padding: '40px' }}>
                <span className="year-badge" style={{ background: 'var(--accent-primary)', color: 'var(--dark-surface-2)', padding: '4px 12px', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 700 }}>{data.badge || 'Milestone'}</span>
